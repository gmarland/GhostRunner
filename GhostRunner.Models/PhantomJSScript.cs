...
{
    public class PhantomJSScript : IGhostRunnerScript
    {
        private Script _script;
        private SequenceScript _sequenceScript;

        public PhantomJSScript()
        {
            _script = new Script();
            _sequenceScript = new SequenceScript();
        }

        public PhantomJSScript(Script script)
        {
            _script = script;
            _sequenceScript = null;
        }

        public PhantomJSScript(SequenceScript sequenceScript)
        {
            _script = null;
